...
/* The app context owns task communication resources so the host simulator can
 * exercise FreeRTOS-style boundaries before real task creation is introduced.
 */
...
/* TelemetryTask step: publish one snapshot of motion/fault state without
 * allowing telemetry formatting to own controller internals.
 */
